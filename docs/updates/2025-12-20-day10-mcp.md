...
[model context protocol](https://modelcontextprotocol.io). it's how AI assistants like claude code get superpowers. install an MCP server, and suddenly your AI can do things it couldn't before.
